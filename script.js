...
const CHANGELOG_ENTRIES = [
    { 
        ...
        description: 'Добавлен раздел "Личный кабинет" с возможностью загрузки аватара, редактирования имени и отображения информации о пользователе. Добавлены новый справочник и поле в форме изделия для указания высоты слоя. Добавлен экспорт Списаний с типом "Продажа" и "Подготовлено" в две xls-формы: продажа, акт передачи (под реализацию)' 
    },    
    { 
        version: '5.9.5', 
