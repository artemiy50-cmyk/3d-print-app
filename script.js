...
console.log("Version: 5.6 (2026-02-14 20-06-31)");
        ...
        steps: [
            ...
            { 
                ...
                popover: { 
                    ...
                    description: 'Это система полного учета вашей печати: от катушки до продажи. Давайте быстро посмотрим, как тут всё устроено.',
            ...
            { 
                ...
                popover: { 
                    ...
                    description: 'Зайдите в Справочники. Добавьте свои принтеры (мощность кВт) и тарифы на электричество. Это база для точного расчета прибыли.', 
                    side: 'right' 
                },
            ...
            { 
                ...
                popover: { 
                    title: '2. Склад пластика', 
                    description: 'Добавьте свои катушки. Система будет сама вычитать метры и граммы при каждом изготовлении изделия.', 
                    side: 'right' 
                },
            ...
            { 
                ...
                popover: { 
                    ...
                    description: 'Укажите цену покупки и вес нетто. Если пластик заканчивается, система подсветит его красным.', 
                    side: 'bottom' 
                } 
            },
            // 6. ИЗДЕЛИЯ
            ...
            { 
                ...
                popover: { 
                    ...
                    description: 'Выберите пластик и время печати. Себестоимость (с учетом света и амортизации) рассчитается мгновенно.', 
                    side: 'bottom' 
                } 
            },
            // СПИСАНИЯ
            { 
                ...
                popover: { 
                    ...
                    description: 'Оформляйте здесь продажи клиентам или списывайте брак. Это формирует вашу финансовую историю.', 
                    side: 'right' 
                },
            ...
            { 
                ...
                popover: { 
                    ...
                    description: 'Учитывайте покупку сопел, ремонт принтеров и другие траты. Это сделает расчет чистой прибыли честным.', 
                    side: 'right' 
                },
